...
const Feed:React.FC = () => {
    ...
    return ( 
            <div className="feed">       
                ...
                {ID && <RecipeList showFollow={false} showAllPosts={showAllPosts} recipeNumber={recipeNum} userId={ID} url='http://localhost:2030/getallpost'/> ? <RecipeList showFollow={true} showAllPosts={showAllPosts} recipeNumber={recipeNum} userId={ID} url='http://localhost:2030/getallpost'/> : <p className="pending-msg">Loading...</p>} 
